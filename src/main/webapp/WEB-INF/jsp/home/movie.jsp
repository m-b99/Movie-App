    ...
    <div class="section movie-section text-light my-1 p-2">
        <div class="movie-overview">
            ...
            <div class="movie-description my-1">
                <h1 style=" word-break: break-word ;" align="center">Description</h1>
                <h5 style=" word-break: break-word ;"  align="justify" >${movie.description}</h5>
            </div>
            ...
            <div class="review-section">
                <ctg:accessRole accessRole="REVIEWER">
                    <form method="post" action="review_add.do" class="form-inline my-2 my-lg-0 review-form">
                        ...
                        <input type="hidden" name="movieId" value="${movie.id}">
                        <textarea name="text" placeholder="Write review" class="form-control mr-sm-2 review-textarea"></textarea>
