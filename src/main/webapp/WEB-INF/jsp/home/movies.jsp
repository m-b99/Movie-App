...
<tags:general title="movie">
            ...
            <c:forEach var="movie" items="${requestScope.movies}">
                <div class="movie-item m-1 p-1 col-sm">
                    ...
                    <div class="movie-item__info">
                            <h3 style=" word-wrap: break-word ; white-space: pre-wrap ; " >${movie.title}</h3>
    ...
    <div class="page-container">
        <div class="prev-page-container mt-2 mb-4">
            <a href="${requestScope.prevPageHref}" class="btn btn-primary">PrevPage</a>
        </div>
        <div class="next-page-container mt-2 mb-4">
            <a href="${requestScope.nextPageHref}" class="btn btn-primary">NextPage</a>
        </div>
    </div>
